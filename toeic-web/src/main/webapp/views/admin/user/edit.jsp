                        ...
                        <div class="well">
                            <form novalidate="novalidate">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="fullName" name="fullName" value="${item.pojo.fullName}" required=""
                                           placeholder='<fmt:message key="label.user.fullName" bundle="${lang}"/>'>
                                    <span class="help-block"></span>
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control" id="username" name="username" value="${item.pojo.name}" required=""
                                           placeholder='<fmt:message key="label.user.name" bundle="${lang}"/>'>
                                    <span class="help-block"></span>
                                </div>

                                <div class="form-group">
                                    <input type="password" class="form-control" id="password" name="password" value="${item.pojo.password}" required=""
